...
def species_to_stars(species, stat_overrides):
    ...
    full_dict = {
        ...
        'rock': create_dict(5, 1, 5, 1, 5, 1, 2, 600, 3, 4, 'spire', 400, 0, 1800, 300, 45, 0),
        'lightning': create_dict(1, 5, 3, 5, 5, 2, 1, 600, 3, 3, 'thunderbolt', 600, 0, 1800, 240, 10, 0),
        'wind': create_dict(1, 5, 2, 5, 1, 5, 1, 600, 3, 3, 'gale', 900, 0, 1800, 720, 0, 240),
        ...
        'boxer': create_dict(4, 2, 5, 2, 2, 1, 4, 600, 4, 2, 'starpunch', 750, 0, 1800, 810, 20, 0),
    }
