...
costume_unlock_popups = { # Key is 
    'quirkless/grayscale_1': ["quirkless_blob_1.png", "Grayscale Quirkless", "Press block after selecting/this blob to toggle costumes!"],
    'fire/grayscale_1': ["fire_blob_1.png", "Grayscale Fire", "Press block after selecting/this blob to toggle costumes!"],
    'ice/grayscale_1': ["ice_blob_1.png", "Grayscale Ice", "Press block after selecting/this blob to toggle costumes!"],
    'water/grayscale_1': ["water_blob_1.png", "Grayscale Water", "Press block after selecting/this blob to toggle costumes!"],
    'rock/grayscale_1': ["rock_blob_1.png", "Grayscale Rock", "Press block after selecting/this blob to toggle costumes!"],
    'lightning/grayscale_1': ["lightning_blob_1.png", "Grayscale Lightning", "Press block after selecting/this blob to toggle costumes!"],
    'wind/grayscale_1': ["wind_blob_1.png", "Grayscale Wind", "Press block after selecting/this blob to toggle costumes!"],
    'judge/grayscale_1': ["judge_blob_1.png", "Grayscale Judge", "Press block after selecting/this blob to toggle costumes!"],
    'doctor/grayscale_1': ["doctor_blob_1.png", "Grayscale Doctor", "Press block after selecting/this blob to toggle costumes!"],
    'king/grayscale_1': ["king_blob_1.png", "Grayscale King", "Press block after selecting/this blob to toggle costumes!"],
    'cop/grayscale_1': ["cop_blob_1.png", "Grayscale Cop", "Press block after selecting/this blob to toggle costumes!"],
    'boxer/grayscale_1': ["boxer_blob_1.png", "Grayscale Boxer", "Press block after selecting/this blob to toggle costumes!"],
    'mirror/grayscale_1': ["mirror_blob_1.png", "Grayscale Mirror", "Press block after selecting/this blob to toggle costumes!"],
    'fisher/grayscale_1': ["fisher_blob_1.png", "Grayscale Fisher", "Press block after selecting/this blob to toggle costumes!"],
}
