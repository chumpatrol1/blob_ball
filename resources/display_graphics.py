...
def draw_gameplay(screen_size, game_display, p1_blob, p2_blob, ball, game_score, timer):
    ...
    text_rect = menu_text.get_rect()
    text_rect.center = (3*screen_size[0]//4, 2*screen_size[1]//7)
    game_display.blit(menu_text, text_rect)
    menu_text = menu_font.render("SAM: "+ str(p2_blob.special_ability_meter), False, (255, 124, 0))
    text_rect = menu_text.get_rect()
    text_rect.center = (screen_size[0]//4, 2*screen_size[1]//7)
    game_display.blit(menu_text, text_rect)
    ...
    text_rect = menu_text.get_rect()
    text_rect.center = (3*screen_size[0]//4, 4*screen_size[1]//7)
    game_display.blit(menu_text, text_rect)
    menu_text = menu_font.render("COOLDOWN: "+ str(p2_blob.boost_cooldown_timer), False, (255, 124, 0))
    text_rect = menu_text.get_rect()
    text_rect.center = (screen_size[0]//4, 4*screen_size[1]//7)
    game_display.blit(menu_text, text_rect)
    if(timer > 0):
