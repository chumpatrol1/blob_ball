...
def draw_menu(game_display, blob):
    ...
    if(blob.status_effects['menu']['type'] == 'cardpack'):
        ...
        if(blob.status_effects['menu']['direction'] == 'left' and blob.status_effects['monado_smash_cooldown'] <= 0):
            game_display.blit(image_cache['joker_card'], ((blob.x_pos - 105) * (1000/1366), ((blob.y_pos - 25)*(382/768))))
            game_display.blit(image_cache['monado']["SMASH"], ((blob.x_pos - 100) * (1000/1366), ((blob.y_pos - 20) *(382/768))))
        else:
            game_display.blit(image_cache['joker_card'], ((blob.x_pos - 105) * (1000/1366), ((blob.y_pos - 5)*(382/768))))
            game_display.blit(image_cache['monado']["SMASH"], ((blob.x_pos - 100) * (1000/1366), (blob.y_pos*(382/768))))
        if(blob.status_effects['monado_smash_cooldown'] > 0):
            pg.draw.rect(game_display, (124, 124, 124), ((blob.x_pos - 105) * (1000/1366), ((blob.y_pos + 165)*(382/768)), 80, 20))
            pg.draw.rect(game_display, (200, 200, 200), ((blob.x_pos - 105) * (1000/1366), ((blob.y_pos + 165)*(382/768)), 80*(blob.status_effects['monado_smash_cooldown']/900), 20))
        #print("3", blob.status_effects['cards']['pulled'][2])
        if(blob.status_effects['menu']['direction'] == 'up' and blob.status_effects['monado_shield_cooldown'] <= 0):
            game_display.blit(image_cache['joker_card'], ((blob.x_pos + 20) * (1000/1366), ((blob.y_pos - 225) *(382/768))))
            game_display.blit(image_cache['monado']["SHIELD"], ((blob.x_pos + 25) * (1000/1366), ((blob.y_pos - 220) *(382/768))))
        else:
            game_display.blit(image_cache['joker_card'], ((blob.x_pos + 20) * (1000/1366), ((blob.y_pos - 205) *(382/768))))
            game_display.blit(image_cache['monado']["SHIELD"], ((blob.x_pos + 25) * (1000/1366), ((blob.y_pos - 200) *(382/768))))
        if(blob.status_effects['monado_shield_cooldown'] > 0):
            pg.draw.rect(game_display, (124, 124, 124), ((blob.x_pos + 20) * (1000/1366), ((blob.y_pos - 35)*(382/768)), 80, 20))
            pg.draw.rect(game_display, (200, 200, 200), ((blob.x_pos + 20) * (1000/1366), ((blob.y_pos - 35)*(382/768)), 80*(blob.status_effects['monado_shield_cooldown']/900), 20))
        #print("2", blob.status_effects['cards']['pulled'][1])
        ...
        if(blob.status_effects['monado_speed_cooldown'] > 0):
            pg.draw.rect(game_display, (124, 124, 124), ((blob.x_pos + 160) * (1000/1366), ((blob.y_pos + 165)*(382/768)), 80, 20))
            pg.draw.rect(game_display, (200, 200, 200), ((blob.x_pos + 160) * (1000/1366), ((blob.y_pos + 165)*(382/768)), 80*(blob.status_effects['monado_speed_cooldown']/900), 20))
        if(blob.status_effects['menu']['direction'] == 'down' and blob.status_effects['monado_chill_cooldown'] <= 0):
            ...
            game_display.blit(image_cache['monado']["CHILL"], ((blob.x_pos + 25) * (1000/1366), ((blob.y_pos+190)*(382/768))))
        else:
            game_display.blit(image_cache['joker_card'], ((blob.x_pos + 20) * (1000/1366), ((blob.y_pos + 205) *(382/768))))
            game_display.blit(image_cache['monado']["CHILL"], ((blob.x_pos + 25) * (1000/1366), ((blob.y_pos+210)*(382/768))))
        if(blob.status_effects['monado_chill_cooldown'] > 0):
            pg.draw.rect(game_display, (124, 124, 124), ((blob.x_pos + 20) * (1000/1366), ((blob.y_pos + 375)*(382/768)), 80, 20))
            pg.draw.rect(game_display, (200, 200, 200), ((blob.x_pos + 20) * (1000/1366), ((blob.y_pos + 375)*(382/768)), 80*(blob.status_effects['monado_shield_cooldown']/900), 20))
